...
class Ticktock(collections.MutableSequence):
    ...
    def __init__(self, data, dtype=None):
        ...
        if isinstance(data, Ticktock):
            ...
            try:
                datamodel.dmarray(data)[0]
            except IndexError:
                self.data = datamodel.dmarray([data])
            else:
                self.data = datamodel.dmarray(data)
...
#            return
    ...
    def getDOY(self):
        ...
        self.DOY = datamodel.dmarray(DOY).astype(int)
        return self.DOY
    ...
    def geteDOY(self):
        ...
        self.eDOY = datamodel.dmarray(eDOY)
        return self.eDOY
    ...
    def getJD(self):
        ...
        JD = datamodel.dmarray(np.zeros(nTAI))
    ...
    def getUNX(self):
        ...
        self.UNX = datamodel.dmarray(UNX)
        return self.UNX
    ...
    def getUTC(self):
        ...
        UTC = datamodel.dmarray(UTC, attrs={'dtype': 'UTC'})
        self.UTC = UTC
        return self.UTC
    ...
    def getGPS(self):
        ...
        self.GPS = datamodel.dmarray(GPS)#.astype(int)
        return self.GPS
    ...
    def getTAI(self):
        ...
        self.TAI = datamodel.dmarray(TAI)
        return self.TAI
    ...
    def getISO(self):
        ...
        self.ISO = datamodel.dmarray(ISO)
        return self.ISO
